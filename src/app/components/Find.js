...
const Find = () => {
  return (
    <div className=" w-[1240px] h-[500px] ml-[145px] relative top-[-350px] rotate-[-25px] flex items-center">
      ...
      />
      <div className=" w-[604px] h-[340px] ml-[-130px]" >
        <h1 className=" text-white font-M PLUS 1 text-[40px] font-bold">Find the Perfect Credit Card<br/> for You</h1>
        <p className=" font-popins text-[16px]  text-gray mt-4 tracking-wide">Discover your ideal credit card with ease. Our comprehensive<br/> selection caters to every financial need and lifestyle. Whether<br/> you seek cashback rewards, travel perks, or building credit, we have the<br/> perfect credit card waiting for you. Unleash the possibilities and find<br/> the credit card that fits your unique goals and aspirations.</p>
