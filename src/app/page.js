    ...
    <div className=" h-[5170px] w-[1530px] bg-blackbg  overflow-hidden ">
      <div className=" w-[1440px] h-[5080px] relative  bg-[url('/images/dora(1).svg')]  ">
        ...
        <Image
          ...
          height={10}
          alt="star"
          className=" w-6 h-6 ml-[1080px] relative top-[60px]"
        />
        <div className="w-[992px] h-[992px] rounded-full  blur-[5000px] bg-green  opacity-15  relative top-[-726px] left-[436px] "></div>
